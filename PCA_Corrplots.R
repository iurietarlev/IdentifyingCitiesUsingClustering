...
#This scipt is designed to plot cos2 and contribution factors maps for PCA dim. reduction
...
#____comment which region is analysed even if entire dataset
#____this is used in naming of the files
region_analysed = "Bath and North East Somerset" #"South West"


#____uncomment if analysing entire dataset
#df_selection = df_original


#___uncomment if analysing a certain region
...
#____set variable names to the LSOA names of the area selected
